...
<body>
    ...
    <script>
        ...
        const age = params.get('age') || '9-11 ans';
        ...
        function showGameForAge(age) {
            ...
            if (age === '6-8 ans') {
                container.innerHTML = `
                    <h2 style=\"color:#a084ee;\">Quiz Images</h2>
                    <p style=\"color:#e6e0ff;\">Choisis la bonne image !</p>
                    <div style=\"display:flex;justify-content:center;gap:20px;\">
                        <img src=\"/img/game1.jpg\" alt=\"Bonne réponse\" style=\"width:110px;cursor:pointer;border-radius:16px;box-shadow:0 2px 12px #6a4cff55;border:3px solid #6a4cff;\" onclick=\"alert('Bravo ! Bonne réponse 🎉')\">
                        <img src=\"/img/game2.jpg\" alt=\"Mauvaise réponse\" style=\"width:110px;cursor:pointer;opacity:0.5;border-radius:16px;box-shadow:0 2px 12px #a084ee55;border:3px solid #a084ee;\" onclick=\"alert('Essaie encore !')\">
                    </div>
