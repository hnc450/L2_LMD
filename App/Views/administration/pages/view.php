...
<div id="editQuizModal" class="modal" style="display:none;">
    <div class="modal-content">
        <span class="close-btn" onclick="closeEditQuizModal()">&times;</span>
        ...
        <form id="editQuizForm">
            ...
            <div class="form-group">
                <label for="edit-contenu-quiz">Contenu</label>
                <textarea id="edit-contenu-quiz" name="contenu" rows="3"></textarea>
            </div>
            <div class="form-group">
                <label for="edit-category-quiz">Catégorie</label>
                <select id="edit-category-quiz" name="category" required>
...
<div id="editExplorationModal" class="modal" style="display:none;">
    <div class="modal-content">
        <span class="close-btn" onclick="closeEditExplorationModal()">&times;</span>
        <h2>Modifier l'Exploration</h2>
    ...
    btn.addEventListener('click', function() {
        ...
        fetch(`/api/jeu/${quizId}`)
            ...
            .then(quiz => {
                ...
                document.getElementById('edit-contenu-quiz').value = quiz[0].contenu;
