        ...
        <main class="main-content">
            ...
            <div class="settings-content">
                <section class="settings-section">
                    ...
                    <form class="settings-form" action="/modifier/information/<?= $_SESSION['user'][0]['id_user'] ?? ''?>" method="POST">
                        <div class="form-group">
                            <label for="pseudo">Pseudo</label>
                            <input type="text" id="pseudo" value="<?= $_SESSION['user'][0]['pseudo'] ?? ''?>" name="pseudo">
                        </div>
                        <div class="form-group">
                ...
                <section class="settings-section">
                    ...
                    <form class="settings-form" action="/update/password/<?= $_SESSION['user'][0]['id_user'] ?? ''?>" method="POST">
                        <div class="form-group">
                ...
                <section class="settings-section">
                    <h2>Compte</h2>
                    <button class="btn-danger delete-account">
                        <i class="fa-solid fa-trash"></i> <a href="/delete/account/<?= $_SESSION['user'][0]['id_user'] ?>">Supprimer mon compte</a>
                    </button>
                </section>
            </div>
        </main>
