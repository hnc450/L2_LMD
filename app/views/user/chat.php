...
<body>
    ...
    <script>
        function loadOnlineUsers() {
            fetch('/chat/online-users')
                ...
                .then(users => {
                    ...
                    if(users.length === 0) {
                        onlineUsersDiv.innerHTML = '<div style="color:gray;text-align:center;">Aucun utilisateur en ligne</div>';
                        return;
                    }
                    users.forEach(user => {
                        ...
                        userDiv.innerHTML = `
                            <img src="${user.avatar ? user.avatar : '/assets/avatar.png'}" alt="Avatar" class="user-avatar">
                            <div class="user-info">
                                <div class="user-name">${user.prenoms}</div>
                ...
                .catch(error => {
                    document.querySelector('.online-users').innerHTML = '<div style="color:red;">Erreur chargement utilisateurs</div>';
                });
        }
        ...
        function loadMessages() {
            fetch('/chat/messages')
                ...
                .then(messages => {
                    ...
                    const myId = <?php echo $_SESSION['user']['id_user']; ?>;
        ...
        // Charger les messages et les utilisateurs en ligne toutes les 5 secondes
        loadMessages();
        loadOnlineUsers();
